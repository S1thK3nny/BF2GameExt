...
- **Barrel Fire Origin Fix** - Fixes projectiles spawning from `bone_head` instead of `hp_fire` on WeaponCannon, so shots come out of the actual barrel hardpoint. INI: `[Fixes] BarrelFireOriginFix=1`
