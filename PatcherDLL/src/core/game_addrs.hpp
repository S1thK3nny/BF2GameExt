...
namespace modtools {
   ...
   // ---- EventManager Lua callback system (docs/RE/OnEventSystem.md) -------------
   // Lets GameExt hand the engine its own Event<T,A> objects so On<Name>/
   // On<Name>Name/Team/Class/Release<Name> are generated by the engine itself.
   // The modtools build compiles the registrars as __cdecl(Event*, lua_CFunction),
   // so the callback function pointers are needed here; the LTCG retail builds
   // folded theirs into the registrar body.
   constexpr uintptr_t event_manager_init        = 0x00798220;  // EventManager::Init, from GameLoop::Init (per mission)
   constexpr uintptr_t event_manager_cleanup     = 0x00798260;  // EventManager::Cleanup, from GameLoop::Cleanup
   constexpr uintptr_t event_node_trigger        = 0x00661f10;  // __thiscall Node::Trigger(Node*, arg0, arg1)
   constexpr uintptr_t event_listeners_cleanup   = 0x007981f0;  // __fastcall Event::Cleanup(Node*)
   // CharacterEvent::mEnterVehicle - the <Character,GameObject> template event.
   // Only its vptr is used, read at runtime from +4; never hardcode the vtable VA.
   constexpr uintptr_t event_char_gameobject_template = 0x00adf414;
   constexpr uintptr_t event_reg_char_go_release = 0x0079a530;
   constexpr uintptr_t event_reg_char_go_on      = 0x0079a640;
   constexpr uintptr_t event_reg_char_go_name    = 0x0079a810;
   constexpr uintptr_t event_reg_char_go_team    = 0x0079a8d0;
   constexpr uintptr_t event_reg_char_go_class   = 0x0079a990;
   constexpr uintptr_t event_cb_char_go_release  = 0x004109d3;
   constexpr uintptr_t event_cb_char_go_on       = 0x004135d9;
   constexpr uintptr_t event_cb_char_go_name     = 0x0041253a;
   constexpr uintptr_t event_cb_char_go_team     = 0x004061b8;
   constexpr uintptr_t event_cb_char_go_class    = 0x0040685c;
...
namespace steam {
   ...
   constexpr uintptr_t game_loop_set_next_mission   = 0x00533700;

   // ---- EventManager Lua callback system (docs/RE/OnEventSystem.md) -------------
   // Lets GameExt hand the engine its own Event<T,A> objects so On<Name>/
   // On<Name>Name/Team/Class/Release<Name> are generated by the engine itself.
   // Retail LTCG: the registrars are __fastcall(Event* ECX) with the callback
   // function pointer folded in, so no event_cb_* entries are needed.
   constexpr uintptr_t event_manager_init        = 0x0050b3a0;
   constexpr uintptr_t event_manager_cleanup     = 0x0050b3d0;
   constexpr uintptr_t event_node_trigger        = 0x004b9820;
   constexpr uintptr_t event_listeners_cleanup   = 0x0050b380;
   constexpr uintptr_t event_char_gameobject_template = 0x007eb980;
   constexpr uintptr_t event_reg_char_go_release = 0x0050cf90;
   constexpr uintptr_t event_reg_char_go_on      = 0x0050d020;
   constexpr uintptr_t event_reg_char_go_name    = 0x0050d1d0;
   constexpr uintptr_t event_reg_char_go_team    = 0x0050d3e0;
   constexpr uintptr_t event_reg_char_go_class   = 0x0050d5f0;
   constexpr uintptr_t event_cb_char_go_release  = 0;
   constexpr uintptr_t event_cb_char_go_on       = 0;
   constexpr uintptr_t event_cb_char_go_name     = 0;
   constexpr uintptr_t event_cb_char_go_team     = 0;
   constexpr uintptr_t event_cb_char_go_class    = 0;
...
namespace gog {
   ...
   constexpr uintptr_t event_node_trigger        = 0x004b9820;
   constexpr uintptr_t event_listeners_cleanup   = 0x0050b380;
   constexpr uintptr_t event_char_gameobject_template = 0x007ec970;
   constexpr uintptr_t event_reg_char_go_release = 0x0050cf90;
   constexpr uintptr_t event_reg_char_go_on      = 0x0050d020;
   constexpr uintptr_t event_reg_char_go_name    = 0x0050d1d0;
   constexpr uintptr_t event_reg_char_go_team    = 0x0050d3e0;
