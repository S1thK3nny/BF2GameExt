...
inline constexpr IniEntry g_ini_registry[] = {
   ...
   INI_ENTRY("Features", "TargetBarLatchSeconds", "2.5", "How long the target bar stays on an enemy after you last hit them or had them under the reticle. This is not a fade time - the fade belongs to the .hud file. 0 never times out"),
